...
/**
 * Servlet implementation class AddChalanServlet
 */
@WebServlet("/AddChalanServlet")
public class AddChalanServlet extends HttpServlet {
...
System.out.println("im here");
		...
		try
		{
			...
			CallableStatement callableSt = (CallableStatement) con.prepareCall("{call add_chalan_detail(?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?)}");
